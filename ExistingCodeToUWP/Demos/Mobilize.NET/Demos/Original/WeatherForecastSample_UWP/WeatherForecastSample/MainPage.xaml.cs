...
namespace WeatherForecastSample
{
      ...
      : Windows.UI.Xaml.Controls.Page
   {
      ...
      /// </summary>
      private void CityList_SelectionChanged(object sender, Windows.UI.Xaml.Controls.SelectionChangedEventArgs e)
      {
         ...
         if ( CityList.SelectedIndex != -1 )
         {
            ...
            this.Frame.Navigate(typeof(WeatherForecastSample.ForecastPage), "City=" + curCity.CityName + "&Latitude=" + curCity.Latitude + "&Longitude=" + curCity.Longitude);
         }
      }
      ...
      /// </summary>
      protected override void OnNavigatedFrom(Windows.UI.Xaml.Navigation.NavigationEventArgs args)
      {
        ...
        private void ApplicationBarMenuItem_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ...
            var aboutPromptItem = new WindowsPhoneUWP.UpgradeHelpers.AboutPromptItem() { AuthorName = "Michael Crump", Role = "PMM", EmailAddress = "micrum@microsoft.com", WebSiteUrl = "http://microsoft.com/" };
