      ...
      : Application
   {
      ...
      protected override void OnLaunched(LaunchActivatedEventArgs e)
      {
         ...
         if ( rootFrame.Content == null )
         {
            ...
            // parameter
            rootFrame.Navigate(typeof(WeatherForecastSample.MainPage), e.Arguments);
         }
      ...
      bool TryToNavigateToTileReference(Frame rootFrame, LaunchActivatedEventArgs e)
      {
         switch ( e.TileId )
         {
            case "_ForecastPage.xaml":
               rootFrame.Navigate(typeof(WeatherForecastSample.ForecastPage), e.Arguments);
               return true;
            case "_MainPage.xaml":
               rootFrame.Navigate(typeof(WeatherForecastSample.MainPage), e.Arguments);
               return true;
